...
Please read this End-User License Agreement carefully before clicking the "I Agree" button, downloading or using "Pepper".
...
- **Application** means the software program provided by the Company downloaded by You to a Device, named "Pepper"
